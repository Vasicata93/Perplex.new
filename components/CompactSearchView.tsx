...
export const CompactSearchView: React.FC<CompactSearchViewProps> = ({
    ...
    const getIcon = (type: ResultType, icon?: string) => {
        ...
        switch (type) {
            ...
            case 'space': return <LayoutGrid size={14} className="text-purple-400" />;
        }
    };
            ...
            {!hideInput && (
                <div className="relative group">
                    <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                        <SearchIcon size={16} className="text-pplx-muted group-focus-within:text-pplx-accent transition-colors" />
                    </div>
                    <input
                        ref={inputRef}
                        type="text"
