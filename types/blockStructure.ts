...
export interface Block {
    id: string;
    type: 'paragraph' | 'heading_1' | 'heading_2' | 'heading_3' | 'bullet_list' | 'numbered_list' | 'todo_list' | 'toggle' | 'code' | 'quote' | 'callout' | 'divider' | 'table' | 'image' | 'video' | 'file' | 'bookmark' | 'equation';
